  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.socialRow}>
        <button type="button" onClick={handleKakaoLogin} style={{...styles.socialBtn, background: '#FEE500'}}>
          <img src="/images/sns-kakao.svg" alt="Kakao" style={{width: 24, height: 24}} />
        </button>
        <button type="button" onClick={handleNaverLogin} style={{...styles.socialBtn, background: '#03C75A', color: '#fff'}}>
          <img src="/images/sns-naver.svg" alt="Naver" style={{width: 24, height: 24}} />
        </button>
        <button type="button" onClick={handleGoogleLogin} style={{...styles.socialBtn, background: '#fff', border: '1px solid #e8e8e8', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
